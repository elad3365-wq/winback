  ...
  return (
    <header
      className={cn(
        ...
        scrolled ? "border-slate-200 bg-white/85 backdrop-blur" : "border-transparent bg-white/0",
      )}
    >
      <nav className="mx-auto flex h-16 max-w-7xl items-center justify-between gap-4 px-4 sm:px-6">
        ...
        <button
          ...
          aria-expanded={open}
          onClick={() => setOpen((v) => !v)}
          className="inline-flex h-10 w-10 items-center justify-center rounded-lg text-slate-700 ring-1 ring-inset ring-slate-200 transition-colors hover:bg-slate-50 lg:hidden"
        >
